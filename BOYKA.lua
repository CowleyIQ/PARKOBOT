...
__ℳ_________🦅________PARKO _𝕋𝕖𝔸𝕞_🦅_________ᔕ ____
...
send(msg.chat_id_, msg.id_,'📡| اصدار سورس باركو \n📟| الاصدار ←{ 1.2v}') 
end
...
usertext = '\n👤| العضو » ['..result.title_..'](t.me/'..(username or 'VIPPARKO')..')'
...
usertext = '\n👤| العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'VIPPARKO')..')'
status  = '\n🔘| تم ترقيته مطور في البوت'
...
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/VIPPARKO)}\n📛¦["..BOYKA_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⚠|عذرا يا » {["..data.first_name_.."](T.ME/VIPPARKO)}\n📮| الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
🕹️︙ PARKO TEAM 🦅
… … … … … … … … … … …
📮︙↬[Source Channel](t.me/VIPPARKO)

🗂️︙↬[Source files](t.me/THE_M2RK)

👲︙↬[Developer](t.me/PARKOO9)

📍︙↬[The way his inauguration](https://t.me/VIPPARKO/6754)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👤| بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'VIPPARKO')..') \n🔘| تـم قفـل الدردشه ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤| بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'VIPPARKO')..') \n🔘| تـم قفـل التاك بالكتم\n⛔| الحاله ←الكتم ')  
end,nil)   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/PARKOBOT1/Files_Boyka/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n📁| اهلا بك في متجر ملفات باركو\n🔰| ملفات السورس ↓\nء━━━━━━━━━━━━\n\n"
local TextE = "\nء━━━━━━━━━━━━\n🔘|  علامة تعني { ✓ } ملف مفعل\n🔘| علامة تعني { ✘ } ملف معطل\n🔖| قناة سورس باركو ↓\n".."📮| [اضغط هنا لدخول](t.me/VIPPARKO) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/PARKOBOT1/Files_Boyka/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('BOYKA.lua')  
else
send(msg.chat_id_, msg.id_,"⚠️| عذرا هاذا ملف ليس من ملفات سورس باركو\n") 
end
return false
end
...
local UserName = (b.username_ or "VIPPARKO")
...
' }\n'..'📮| الايدي بالصوره ← { '..idph..
' }\n'..'📮| الرفع ← { '..setadd..
' }\n'..'📮| الحظر ← { '..banm..' }\n\n┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉  ┉  ┉\n🔖| CH » [Channel PARKO 🦅](https://t.me/VIPPARKO)\n'
send(msg.chat_id_, msg.id_,text)     
end    
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤| العضو » ['..result.title_..'](t.me/'..(text1[3] or 'VIPPARKO')..')'..'\n🔘| تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'باركو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'باركو')
local BOYKA_Msg = {
'اسمي مينو كول💘؟',
'دا اشرب جاي مفارغلك',
'حبيبي القميل كول 😻',
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'باركو').."مغادره" or text == 'مغادره' or text == 'مغادرة' then  
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'باركو')
